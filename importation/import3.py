...
for id in idlist:
	...
	try:
		...
		# Note: Had to revert to the SQL insert line from hell because the comma in the opponentname field was throwing an error, will try to figure this out for the final project submission. In the meantime, the insert statement from hell works.
