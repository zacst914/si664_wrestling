<?php 
    session_start();
    if ( !isset($_SESSION['username']) || $_SESSION['acct_type'] != 1 ) {
...
<a href="/mwrestling/admin_announcements.php">
announcements
</a>
|
<a href="/mwrestling/admin_stats.php">
leaderboards
</a>
|
...
|
<a href="/mwrestling/admin_myaccount.php">
my account
</a>
|
